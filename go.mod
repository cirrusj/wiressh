module github.com/cirrusj/wiressh

go 1.24.0

toolchain go1.24.1

replace github.com/tailscale/wireguard-go v0.0.0-20250107165329-0b8b35511f19 => github.com/cirrusj/wireguard-go v0.0.0-20250414190652-2c54e620eea1
